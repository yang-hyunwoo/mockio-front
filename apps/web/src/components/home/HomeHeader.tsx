        ...
        <header className="flex flex-wrap items-center justify-between gap-6">
            <div className="flex items-center gap-6">
                ...
                <nav className="hidden items-center gap-5 text-sm font-medium lg:flex">
                    <Link
                        href="/notice"
                        className="text-[var(--brand-muted)] transition-colors hover:text-foreground"
                    >
                        공지사항
                    </Link>
                        ...
                        <>
                            <div className="relative group">
                                ...
                                <div className="absolute left-0 top-full z-50 hidden pt-3 group-hover:block">
                                    <div
                                        className="min-w-[220px] overflow-hidden rounded-2xl border border-white/30
                            ...
                            <div className="relative group">
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-auto px-0 font-medium text-[var(--brand-muted)] hover:text-foreground"
                                    rightIcon={
                                        <span className="text-[10px] opacity-70 transition-transform group-hover:rotate-180">
                                            ▾
                                        </span>
